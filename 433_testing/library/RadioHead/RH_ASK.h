...
public:
    ...
    /// \param[in] rxPin The pin that is used to get data from the receiver 11
    /// \param[in] txPin The pin that is used to send data to the transmitter 12
    ...
    RH_ASK(uint16_t speed = 2000, uint8_t rxPin = 3, uint8_t txPin = 8, uint8_t pttPin = 10, bool pttInverted = false);
